...
async function captcha (
    ...
    for (i = 0; i < bezier; i++) cmd += ` -fill none -stroke ${random(colors)} -strokeWidth 1 -draw "bezier 0,${random(height)} ${width / 4},${random(height)} ${width / 2},${random(height)} ${width},${random(height)}" `;
